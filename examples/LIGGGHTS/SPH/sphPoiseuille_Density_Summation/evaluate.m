...
legend(['SPH/STL, t = ',num2str(ts(1)),' ms'],['SPH/STL, t = ',num2str(ts(2)),' ms'], ...
    ['SPH/STL, t = ',num2str(ts(3)),' ms'],'analytical','Location','NorthEast')
