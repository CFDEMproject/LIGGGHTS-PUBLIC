...
# vizplotgui_gl.py
# Purpose: viz running LIGGGHTS simulation via GL tool with plot and GUI
# Syntax:  vizplotgui_gl.py in.liggghts Nfreq compute-ID
...
argv = sys.argv
if len(argv) != 4:
  print "Syntax: vizplotgui_gl.py in.liggghts Nfreq compute-ID"
  sys.exit()
