...
# viz_gl.py
# Purpose: viz running LIGGGHTS simulation via GL tool in Pizza.py
# Syntax:  viz_gl.py in.liggghts Nfreq Nsteps
...
argv = sys.argv
if len(argv) != 4:
  print "Syntax: viz_gl.py in.liggghts Nfreq Nsteps"
  sys.exit()
